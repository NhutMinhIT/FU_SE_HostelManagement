                        ...
                        <div class="card-body">
                            ...
                            <form action="${pageContext.request.contextPath}/MainController" method="POST">
                                            ...
                                            <select id="city"  name="city" style="padding:6px 0; border-radius: 3px; width: 50%" >
                                                ...
                                                <%
                                                    try {
                                                        ...
                                                        Connection conn = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=HostelDB", "fptnhutminh", "221200");
                                                ...
                                                <%
                                                    ...
                                                    {
                                                        if(rs.getInt("city_id")==Integer.parseInt(request.getParameter("city"))){
                                                           out.print("selected");
                                                    }
                                                    }
                                                        }
                                    ...
                                    <div class="form-group row col-md-6 mt-2">
                                        ...
                                        <div class="col-sm-8">
                                            <select id="select-state1"  name="district"  style="padding:6px 0; border-radius: 3px; width: 50%" >
                                                ...
                                                <%
                                                    try {
                                                        String query = "Select * from dbo.District where city_id= '79'";
                                                        Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver").newInstance();
                                                        Connection con = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=HostelDB", "nhutminh", "221200");
                                                ...
                                                <%
                                                    ...
                                                    {
                                                       if(rs.getInt("city_id")==Integer.parseInt(request.getParameter("district_name"))){
                                                           out.print("selected");
                                                    }
                                                    }
                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <button class="btn btn-success" type="submit" name="action" id="sumbitButton" value="AddHostel" onchange="this.form.submit();" ><i class="fa fa-check"></i> Lưu</button>
                                </div>
                            </form>
