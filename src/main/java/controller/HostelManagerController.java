 ...
 * @author avillX
 */
@WebServlet(name = "HostelManagerController", urlPatterns = {"/HostelManagerController"})
public class HostelManagerController extends HttpServlet {

    private static final String ERROR = "View/room.jsp";
