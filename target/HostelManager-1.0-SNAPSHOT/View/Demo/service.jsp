                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>20/06/2022</td>
                                            <td>Địa điểm</td>
                                            <td><input type="text" name="" value="3000" disabled="disable" style="width: 100%"/></td>                                     
                                            <td>KWh</td>
                                            <td style="text-align: center"><input type="checkbox" checked disabled="disabled" /></td>
                                            <td>
                                                <a href="editService.jsp">
                                        ...
                                        <tr>
                                            ...
                                            <td>20/06/2022</td> 
                                            <td>Địa điểm</td>
                                            <td><input type="text" name="" value="18000" disabled="disable" style="width: 100%"/></td>                                     
                                            <td>Đồng/m3</td>
                                            <td style="text-align: center"><input type="checkbox" checked disabled="disabled" /></td>
                                            <td>
                                                <a href="editService.jsp">
