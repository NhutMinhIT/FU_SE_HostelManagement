                                ...
                                <form action="#">
                                    <div class="row">
                                        <div class="form-group row col-md-6 mt-2">
                                            ...
                                            <div class="col col-sm-8">
                                                <input type="text" class="form-control" placeholder="Tên dịch vụ" required pattern="\S+">
                                            </div>
                                        </div>
                                        <div class="form-group row col-md-6 mt-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group row col-md-6 mt-2">
                                            ...
                                            <div class="col-sm-8">
                                                <input style="width: 100%" type="text" class="form-control" placeholder="Tên khu trọ" required pattern="\S+">
                                    ...
                                    <div class="row">
                                        <div class="form-group row col-md-6 mt-2">
                                            ...
                                            <div class="col col-sm-8">
                                                <input type="number" class="form-control" placeholder="Giá" required pattern="[0-9]">
                                            </div>
                                        </div>
                                        <div class="form-group row col-md-6 mt-2">
