                    ...
                    <div class="container-fluid px-4">
                        <div class="card mt-4">
                            <div class="card-header">
                                <h1 class="text-info">Chỉnh sửa Dịch Vụ</h1>
                            </div>
                            <div class="card-body">
                                <form action="#">
                                    <div class="row">
                                        <div class="form-group row col-md-6 mt-2">
                                            ...
                                            <div class="col col-sm-8">
                                                <input type="text" class="form-control" value="Điện" required pattern="\S+">
                                            </div>
                                        </div>
                                        <div class="form-group row col-md-6 mt-2">
                                            <label  class="col-sm-4 col-form-label">Loại dịch vụ:</label>
                                            <div class="col-sm-8">
                                                <select id="#" style="padding:6px 0; border-radius: 3px; width: 50%" >
                                                    <option value="first">ĐIỆN</option>
                                                    <option value="second">NƯỚC</option>
                                                    <option value="third">KHÁC</option>
                                                </select> 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group row col-md-6 mt-2">
                                            ...
                                            <div class="col-sm-8">
                                                <input style="width: 100%" type="text" class="form-control" value="Moon" required pattern="\S+">
                                    ...
                                    <div class="row">
                                        <div class="form-group row col-md-6 mt-2">
                                            ...
                                            <div class="col col-sm-8">
                                                <input type="number" class="form-control" value="3000" required pattern="[0-9]">
                                            </div>
                                        </div>
                                        <div class="form-group row col-md-6 mt-2">
